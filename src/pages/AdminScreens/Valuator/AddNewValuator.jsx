...
const AddNewValuator = () => {
  ...
  return (
    <Page className={"dashboard mt-3"} title={'Add Valuator'} breadcrumbs={[{name:"Home", active:false},{name:"add valuator", active:true}]}>
                ...
                {() => (
                    ...
                    <Row>
                        ...
                        <BootstrapForm.Group controlId="empName" className='mb-2'>
                            <BootstrapForm.Label className='mb-1'>Valuator Name <span className='text-danger'>*</span></BootstrapForm.Label>
                        ...
                        <BootstrapForm.Group controlId="empNo" className='mb-2'>
                            <BootstrapForm.Label className='mb-1'>Valuator Id <span className='text-danger'>*</span></BootstrapForm.Label>
